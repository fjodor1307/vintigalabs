...
export function AddCollectionScreen() {
  ...
  function save() {
    ...
    window.location.hash = '#/web/experiences/collections'
  }
        ...
        <div className="flex-1 p-vintiga-xl flex flex-col gap-vintiga-md min-w-0">
          <Breadcrumb
            items={[
              ...
              { label: 'Collections', href: '#/web/experiences/collections' },
          ...
          <div className="flex items-center justify-between gap-vintiga-md">
            ...
            <div className="flex items-center gap-2">
              <Button variant="outline" as="a" href="#/web/experiences/collections">Cancel</Button>
        ...
        <RightRail>
          ...
          >
            ...
            <div className="flex flex-wrap gap-1.5">
              <Tag variant="outline" onRemove={() => {}}>Experiences</Tag>
              <Tag variant="outline" onRemove={() => {}}>Tastings</Tag>
            </div>
          </RailSection>
        </RightRail>
      </div>
