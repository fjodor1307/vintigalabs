  ...
  return (
    <ProductLayout activeTab="website">
      <SectionCard title="Website">
        ...
        <Field
          label="Teaser"
          helper="Shown on the experiences listing page online."
          action={<AiSuggestButton onClick={fakeGen} generating={generating} />}
        >
      ...
      <SectionCard title="SEO">
        ...
        <Field label="Slug" helper="Defaults to the experience title with hyphens (e.g. reserve-cellar-tasting).">
          <TextInput placeholder="reserve-cellar-tasting" />
        </Field>
      </SectionCard>
    </ProductLayout>
  )
