...
- **🔴 Experience → Option (variants)** — hide the Option selector when an experience has a single variant; when 2+, flatten them into the experience picker ("Lunch – Patio", "Lunch – Dining room"). Seed one experience with a variant + one without. · Donna, Jul 9
