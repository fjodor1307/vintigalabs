...
// Mixes manual staff adjustments with automated club + integration entries so
// the visual distinction in TransactionsTable reads end-to-end.
const SEED_BALANCE_LEDGER: LedgerEntry[] = [
  {
    id: 'bal-1',
    timestamp: '2026-05-04T14:14:00',
    source: 'vintiga',
    sourceName: 'Tasting Credit Club · MBR-1284',
    orderNumber: '#124444',
  ...
  },
  {
    ...
    source: 'vintiga',
    sourceName: 'POS · Tasting Room',
    orderNumber: '#124298',
    description: 'POS redemption — lunch tab',
    amount: -76.50,
  },
  {
    id: 'bal-3',
  ...
  },
  {
    ...
    description: 'Refund — wrong vintage shipped',
    amount: 75.00,
  },
  {
    id: 'bal-11',
