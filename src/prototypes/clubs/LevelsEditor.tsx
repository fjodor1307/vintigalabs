...
// ─── LevelsEditor ────────────────────────────────────────────────────────────
// Shared body for the Levels page — used by both `ClubLevelsScreen` (new-club
// editor) and `ClubViewLevelsScreen` (existing-club view) so adding, editing,
// reordering, and removing levels behaves identically in both flows.
//
// Backed by the in-progress `clubStore` draft; the prototype intentionally
// shares state across the two surfaces so changes round-trip end-to-end.
